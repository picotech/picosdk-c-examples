...
#pragma region Windows Form Designer generated code
      ...
      // Execute
      // 
      this->Execute->Location = System::Drawing::Point(934, 24);
      ...
      // textBox1
      // 
      this->textBox1->Location = System::Drawing::Point(934, 79);
      ...
      this->label1->Location = System::Drawing::Point(1039, 41);
      ...
      // ListAllDevices
      // 
      this->ListAllDevices->Location = System::Drawing::Point(426, 3);
      this->ListAllDevices->Name = L"ListAllDevices";
      this->ListAllDevices->Size = System::Drawing::Size(129, 32);
      ...
      // SelectDevices
      // 
      this->SelectDevices->Location = System::Drawing::Point(426, 41);
      this->SelectDevices->Name = L"SelectDevices";
      this->SelectDevices->Size = System::Drawing::Size(129, 31);
      ...
      // TimebaseInput
      // 
      this->TimebaseInput->Location = System::Drawing::Point(743, 14);
      ...
      // BufferSizeInput
      // 
      this->BufferSizeInput->Location = System::Drawing::Point(743, 46);
      ...
      // MinPulseWidthInput
      // 
      this->MinPulseWidthInput->Location = System::Drawing::Point(743, 111);
      ...
      // minThreshold
      // 
      this->minThreshold->Location = System::Drawing::Point(743, 145);
      ...
      // MaxPulseWidthInput
      // 
      this->MaxPulseWidthInput->Location = System::Drawing::Point(821, 111);
      ...
      // maxThreshold
      // 
      this->maxThreshold->Location = System::Drawing::Point(821, 143);
      ...
      // MaxHysteresisInput
      // 
      this->MaxHysteresisInput->Location = System::Drawing::Point(821, 176);
      ...
      // MinHysteresisInput
      // 
      this->MinHysteresisInput->Location = System::Drawing::Point(743, 178);
      ...
      // Stop
      // 
      this->Stop->Location = System::Drawing::Point(934, 117);
      ...
      this->TriggerTypeInput->Items->AddRange(gcnew cli::array< System::Object^  >(3) { L"Simple", L"Pulse Width", L"Drop Out" });
      this->TriggerTypeInput->Location = System::Drawing::Point(743, 77);
...
#pragma pack(1)
  ...
  #pragma pack(1)
      ...
      for (int32_t graphNumber = 0; graphNumber < this->count; graphNumber++) {
        ...
        for (char devCount = 0; devCount < NUMBER_OF_CHANNELS; devCount++) {
          localChart->Series->Add("Channel " + (devCount + 'A'));
          localChart->Series["Channel " + (devCount + 'A')]->Color = Color::FromArgb((((devCount & 1) == 1) * 200), (((devCount & 2) == 2) * 200), (((devCount & 4) == 4) * 200));
        ...
        for (char channel = 0; channel < NUMBER_OF_CHANNELS; channel++) {
          ...
          for (int i = 0; i < TEN_MEGA_SAMPLES ; i++)
            localChart->Series["Channel " + ( channel + 'A' )]->Points->AddXY(-PRE_TRIGGER + i , dev.buffer[channel][i]);
        }
...
private: System::Void FindDevices_Click(System::Object^ sender, System::EventArgs^ e) {
  ...
  this->count = count;
  this->Controls["ListAllDevices"]->Text = "" + count;
  std::string str;
