...
#include <libps6000a-1.1/ps6000aApi.h>
#ifndef PICO_STATUS
#include <libps6000a-1.1/PicoStatus.h>
#endif
...
* Returns       none
***************************************************************************/
void mainMenu(GENERICUNIT*unit)
{
	int8_t ch = '.';
	while (ch != 'X')
	{
...
int32_t main(void)
{
	...
	GENERICUNIT allUnits[MAX_PICO_DEVICES];
