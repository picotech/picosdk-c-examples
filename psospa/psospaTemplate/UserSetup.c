...
void userSetup(GENERICUNIT* unit)
{
	...
	unit->channelSettings[0].rangeMax = inputRanges[unit->channelSettings[0].range] * 1000000;// convert mV to nV
	unit->channelSettings[0].rangeMin = inputRanges[unit->channelSettings[0].range] * -1000000;
