...
#ifndef __LIBPS6000A_H__
#define __LIBPS6000A_H__
...
#define ENABLED_CHS_LIMIT 8 //Set to limit the max number channels to enable (for example if set to 2 then ChA and ChB will be turned on)
